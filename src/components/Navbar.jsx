...
const url_cv = 'https://drive.google.com/file/d/1ElKOKWN0XHyW_jkZrSoT8Vdq9RU0S1qq/view?usp=sharing'
        ...
        <header className={`fixed top-0 left-0 right-0 z-10 py-3 backdrop-filter backdrop-blur-md  ${darkTheme ? 'bg-gray-800 text-white bg-opacity-90' : 'bg-white text-gray-900 bg-opacity-70'} `}>
            <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 lg:px-8" aria-label="Global">
                ...
                <div className="hidden lg:flex justify-end lg:gap-x-12 ml-10">
                    ...
                    <button className={`text-lg font-semibold rounded-full ${darkTheme ? 'text-white bg-violet-900 hover:bg-violet-700 hover:text-white py-2 px-4 border-2 border-violet-900' : 'text-violet-700 hover:bg-violet-700 hover:text-white py-2 px-4 border-2 border-violet-700'} `}
                        onClick={() => window.open(url_cv, '_blank')}>
                    ...
                    <div className="mt-6 flow-root">
                        <div className="text-center -my-6 divide-y divide-gray-500/10">
                            <div className="py-6">
                                ...
                                <a onClick={() => window.open(url_cv, '_blank')} className={`cursor-pointer -mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 ${darkTheme ? 'text-white hover:bg-gray-800' : 'text-gray-900 hover:bg-gray-50'}`}>
