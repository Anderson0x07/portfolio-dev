  ...
  return (
    <section id='contact' className={`${darkTheme ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'} relative isolate overflow-hidden px-6 pb-12 sm:pb-32 lg:px-8`}>
      <div className='mx-auto max-w-2xl lg:max-w-4xl'>
        <h2 className='text-center text-3xl font-bold tracking-tight sm:text-4xl mb-7'>Envíame un email</h2>
        ...
        <blockquote className='sm:text-center text-xl font-semibold leading-8  sm:text-2xl sm:leading-9'>
          ...
          <div className='flex gap-2'>
            <label htmlFor='email' className='flex w-full'>
              ...
              <button aria-label='Send email' className={`flex rounded-xl border-2 py-2 px-4 transition-colors ease-in-out duration-300 mx-2 ${darkTheme ? 'text-white bg-violet-900 hover:bg-violet-700 hover:text-white border-violet-900' : 'text-violet-700 hover:bg-violet-700 hover:text-white border-violet-700'}`} onClick={() => sendEmail()}>
